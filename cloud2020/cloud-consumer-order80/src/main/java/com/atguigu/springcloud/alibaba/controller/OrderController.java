...
/**
 * @author zero
 * @create 2020-06-25 22:16
 */
@RestController
@Slf4j
public class OrderController {

    //    public static final String PAYMENT_URL = "http://localhost:8001"; //不能写死端口
    ...
    public CommonResult<Payment> getPayment2(@PathVariable("id") Long id) {
        ...
        if (entity.getStatusCode().is2xxSuccessful()) {
            ...
            log.info("getStatusCode-->" + entity.getStatusCode() + ",getHeaders-->" + entity.getHeaders() + ",getStatusCodeValue-->" + entity.getStatusCodeValue());
    ...
    @PostMapping("/consumer/payment/postGetForEntity/{id}")
